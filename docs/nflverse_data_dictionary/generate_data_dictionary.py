#!/usr/bin/env python3
"""
NFLverse Data Dictionary Generator
Generates Excel workbook and Markdown documentation from scraped NFLverse data dictionaries.
"""
...
# Output paths
OUTPUT_DIR = Path("/Users/keyonnesession/Desktop/NFL QUANT/docs/nflverse_data_dictionary")
EXCEL_PATH = OUTPUT_DIR / "nflverse_data_dictionary.xlsx"
MARKDOWN_PATH = OUTPUT_DIR / "nflverse_data_dictionary.md"

# All scraped data dictionaries
DICTIONARIES = {
    "play_by_play": {
        "description": "Play-by-play data for NFL games with detailed play information, EPA, WPA, and player involvement",
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_pbp.html",
        "fields": [
    ...
    "player_stats": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_player_stats.html",
        "fields": [
    ...
    "players": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_players.html",
        "fields": [
    ...
    "rosters": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_rosters.html",
        "fields": [
    ...
    "schedules": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_schedules.html",
        "fields": [
    ...
    "nextgen_stats": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_nextgen_stats.html",
        "fields": [
    ...
    "pfr_passing": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_pfr_passing.html",
        "fields": [
    ...
    "snap_counts": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_snap_counts.html",
        "fields": [
    ...
    "team_stats": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_team_stats.html",
        "fields": [
            ("season", "numeric", "Official NFL season"),
            ("week", "numeric", "Game week number"),
    ...
    "combine": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_combine.html",
        "fields": [
    ...
    "contracts": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_contracts.html",
        "fields": [
            ("player", "character", "Player name"),
    ...
    "depth_charts": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_depth_charts.html",
        "fields": [
    ...
    "draft_picks": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_draft_picks.html",
        "fields": [
    ...
    "espn_qbr": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_espn_qbr.html",
        "fields": [
    ...
    "injuries": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_injuries.html",
        "fields": [
            ("season", "numeric", "Season(s) the specified timeframe belongs to."),
    ...
    "participation": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_participation.html",
        "fields": [
    ...
    "ftn_charting": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_ftn_charting.html",
        "fields": [
    ...
    "ff_playerids": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_ff_playerids.html",
        "fields": [
    ...
    "ff_rankings": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_ff_rankings.html",
        "fields": [
    ...
    "trades": {
        ...
        "source_url": "https://nflreadr.nflverse.com/articles/dictionary_trades.html",
        "fields": [
...
def create_excel_workbook():
    """Create Excel workbook with all data dictionaries."""
    ...
    with pd.ExcelWriter(EXCEL_PATH, engine='openpyxl') as writer:
        ...
        for dict_name, dict_data in DICTIONARIES.items():
            for field_name, data_type, description in dict_data["fields"]:
                master_index.append({
                    "Field Name": field_name,
                    "Data Type": data_type,
                    "Description": description,
                    "Source Dataset": dict_name,
                    "Source URL": dict_data["source_url"]
                })

        master_df = pd.DataFrame(master_index)
        master_df.to_excel(writer, sheet_name="Master_Index", index=False)

        # Create individual sheets for each dictionary
        for dict_name, dict_data in DICTIONARIES.items():
            df = pd.DataFrame(dict_data["fields"], columns=["Field Name", "Data Type", "Description"])
            sheet_name = dict_name[:31]  # Excel sheet name limit
...
def create_markdown_document(master_df):
    """Create comprehensive markdown documentation."""
    print("Creating markdown document...")

    # Calculate statistics
    total_fields = len(master_df)
    unique_fields = master_df["Field Name"].nunique()

    # Find common fields
    field_counts = master_df.groupby("Field Name")["Source Dataset"].apply(list).to_dict()
    common_fields = {k: v for k, v in field_counts.items() if len(v) > 1}

    # Data type distribution
    type_dist = master_df["Data Type"].value_counts().to_dict()

    md_content = f"""# NFLverse Data Dictionary
...
"""
    ...
    # Add TOC entries for each dictionary
    for i, dict_name in enumerate(DICTIONARIES.keys(), start=1):
        md_content += f"   - [{dict_name.replace('_', ' ').title()}](#{dict_name.replace('_', '-')})\n"
...
|--------|-------|
"""
    md_content += f"| Total Fields (including duplicates) | {total_fields} |\n"
    md_content += f"| Unique Field Names | {unique_fields} |\n"
    md_content += f"| Number of Datasets | {len(DICTIONARIES)} |\n"
    md_content += f"| Fields in Multiple Datasets | {len(common_fields)} |\n"
...
|------------|------------|
"""
    for field, datasets in sorted(common_fields.items(), key=lambda x: -len(x[1])):
        datasets_str = ", ".join(datasets)
        md_content += f"| `{field}` | {datasets_str} |\n"
...
"""
    ...
    # Add each dictionary
    for dict_name, dict_data in DICTIONARIES.items():
        md_content += f"### {dict_name.replace('_', ' ').title()}\n\n"
        md_content += f"**Description:** {dict_data['description']}\n\n"
        md_content += f"**Source:** [{dict_data['source_url']}]({dict_data['source_url']})\n\n"
        md_content += f"**Fields:** {len(dict_data['fields'])}\n\n"
        md_content += "| Field Name | Data Type | Description |\n"
        md_content += "|------------|-----------|-------------|\n"

        for field_name, data_type, description in dict_data["fields"]:
            # Escape pipe characters in description
            desc_escaped = description.replace("|", "\\|")
            md_content += f"| `{field_name}` | {data_type} | {desc_escaped} |\n"
    ...
    print(f"Markdown document saved to: {MARKDOWN_PATH}")
...
def main():
    ...
    print("=" * 60)
    print("NFLverse Data Dictionary Generator")
    print("=" * 60)

    # Create Excel workbook
    master_df = create_excel_workbook()

    # Create markdown document
    stats = create_markdown_document(master_df)
    ...
    print(f"Common Fields (cross-dataset): {stats['common_fields_count']}")
    print(f"Datasets Documented: {len(DICTIONARIES)}")
    print("\nData Type Distribution:")
    for dtype, count in sorted(stats['type_distribution'].items(), key=lambda x: -x[1]):
        print(f"  {dtype}: {count}")
    print("\nOutputs:")
